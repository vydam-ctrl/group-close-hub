    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "in-review-bg": "hsl(var(--status-in-review-bg))",
          "in-review-foreground": "hsl(var(--status-in-review-foreground))",
          received: "hsl(var(--status-received))",
          "received-bg": "hsl(var(--status-received-bg))",
          "received-foreground": "hsl(var(--status-received-foreground))",
          rejected: "hsl(var(--status-rejected))",
          "rejected-bg": "hsl(var(--status-rejected-bg))",
          "rejected-foreground": "hsl(var(--status-rejected-foreground))",
          "not-sent": "hsl(var(--status-not-sent))",
          "not-sent-bg": "hsl(var(--status-not-sent-bg))",
          "not-sent-foreground": "hsl(var(--status-not-sent-foreground))",
